...
function X0() {
  const e2 = Je(vn), t = m.useMemo(() => {
    const n = e2 == null ? void 0 : e2.messages;
    if (n == null ? void 0 : n.num_bytes_rx) return n.num_bytes_rx.map((r, i) => {
      var _a2, _b, _c2, _d2;
      return { type: V0[i], ingressBytes: (_a2 = n.num_bytes_rx) == null ? void 0 : _a2[i], ingressMessageCount: (_b = n.num_bytes_tx) == null ? void 0 : _b[i], egressBytes: (_c2 = n.num_messages_rx) == null ? void 0 : _c2[i], egressMessageCount: (_d2 = n.num_messages_tx) == null ? void 0 : _d2[i] };
    });
  }, [e2]);
  if (t) return d.jsxs("div", { style: { minWidth: "500px" }, children: [d.jsx(De, { children: "Messages" }), d.jsxs(Nr, { children: [d.jsx(Pr, { children: d.jsxs(dn, { children: [d.jsx(qe, { children: "Type" }), d.jsx(qe, { children: "Ingress" }), d.jsx(qe, { children: "Egress" }), d.jsx(qe, { children: "PPS in" }), d.jsx(qe, { children: "PPS out" })] }) }), d.jsx(Ar, { children: t == null ? void 0 : t.map((n) => d.jsxs(dn, { children: [d.jsx(Br, { children: n.type }), d.jsx(Bt, { value: n.ingressBytes ?? 0, inBytes: true }), d.jsx(Bt, { value: n.egressBytes ?? 0, inBytes: true }), d.jsx(Bt, { value: n.ingressMessageCount ?? 0 }), d.jsx(Bt, { value: n.egressMessageCount ?? 0 })] }, n.type)) })] })] });
}
